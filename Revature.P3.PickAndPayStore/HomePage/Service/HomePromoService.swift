...
class HomePromoService{
    ...
    func getData() -> [PromoViewModel]{
        let promoModelData = [PromoModel(image: "xbox1"), PromoModel(image: "purinaBeneful_v2"), PromoModel(image: "xbox1"), PromoModel(image: "purinaBeneful_v2"), PromoModel(image: "xbox1")]
